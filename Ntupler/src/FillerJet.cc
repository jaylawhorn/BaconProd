...
FillerJet::FillerJet(const edm::ParameterSet &iConfig):
  ...
  fJetName            (iConfig.getUntrackedParameter<std::string>("jetName","ak4PFJets")),
  fGenJetName         (iConfig.getUntrackedParameter<std::string>("genJetName","AKT4GenJets")),
  fJetFlavorName      (iConfig.getUntrackedParameter<std::string>("jetFlavorName","AKT4byValAlgo")),
  fJetFlavorPhysName  (iConfig.getUntrackedParameter<std::string>("jetFlavorPhysName","AKT4byValPhys")),
